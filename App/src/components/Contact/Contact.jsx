...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_mgl86zp', 'template_fr1bbux', form.current, {
        publicKey: '8dY-aVmDrM_DuOxnb',
      })
      e.target.reset();
  };
  return (
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">bhattjay114@gmail.com</span>

              <a href="mailto:bhattjay114@gmail.com" className="contact_button">
                Write me{" "}
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">+91 8769297221</span>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">@Jay_Bhatt</span>
